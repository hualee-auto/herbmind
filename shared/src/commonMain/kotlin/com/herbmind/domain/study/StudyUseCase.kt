package com.herbmind.domain.study

import com.herbmind.data.HerbDatabase
import com.herbmind.data.model.Herb
import kotlinx.serialization.json.Json
import kotlinx.serialization.decodeFromString
import com.herbmind.domain.study.SM2Algorithm.Rating
import com.herbmind.domain.study.SM2Algorithm.StudyStatus
...
class StudyUseCase(
    ...
    private fun com.herbmind.data.Herb.toHerb(json: Json): Herb {
        return Herb(
            id = id,
            name = name,
            pinyin = pinyin,
    ...
    private fun mapToStudyProgress(
        progress: com.herbmind.data.Study_progress,
        herb: Herb
    ): StudyProgress {
